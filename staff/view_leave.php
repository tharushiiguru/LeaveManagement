...
<?php
	...
	{ 
		...
		if ($status === '2') {
			$result = mysqli_query($conn,"update leavetype_tblemployees set assignee_status='REJECTED' where id=$did");
		...
		elseif ($status === '1') {
				$result = mysqli_query($conn,"update leavetype_tblemployees set assignee_status='APPROVED' where id=$did");
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="selectpicker form-control" data-style="btn-outline-info" readonly value="<?php echo htmlentities($result->no_of_days);?>">
								</div>
							</div>
							<!-- <div class="col-md-4 col-sm-12">
								<div class="form-group">
