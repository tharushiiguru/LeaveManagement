			...
			<div class="row pb-10">
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php
						$sql = "select * from leavetype_tblemployees where emp_id = '$session_id'";
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=1;
						 $query = mysqli_query($conn,"select * from leavetype_tblemployees where emp_id = '$session_id' AND hod_status = 'APPROVED'")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=0;
						 $query_pend = mysqli_query($conn,"select * from leavetype_tblemployees where emp_id = '$session_id' AND hod_status = 'PENDING'")or die(mysqli_error());
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $status=2;
						 $query_reject = mysqli_query($conn,"select * from leavetype_tblemployees where emp_id = '$session_id' AND (hod_status = 'REJECTED' OR assignee_status='REJECTED')")or die(mysqli_error());
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php 
                                    $sql = "SELECT id,no_of_days,leave_date,leave_end_date,assignee_status,hod_status,FirstName,LastName,leave_type from leavetype_tblemployees,tblemployees,leavetype where leavetype_tblemployees.emp_id='$session_id' AND leavetype_tblemployees.emp_id=tblemployees.emp_id AND leavetype_tblemployees.leavetype_no=leavetype.leavetype_no";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                                    $cnt=1;
                                  ...
                                  <td><?php $stats=$result->hod_status;
                                       if($stats=="APPROVED"){
                                        ?>
                                    ...
                                    <td><?php $stats=$result->assignee_status;
                                       if($stats=="APPROVED"){
                                        ?>
                                           <span style="color: green">Approved</span>
                                            <?php } if($stats=="REJECTED")  { ?>
